...
class Ddmedical extends Component {
  constructor(props) {
    super(props);
    this.state = {
      results: [],
 ...
 // };
  ...
  <Form>
      ...
      <FormGroup>
        ...
        <Input type="text" name="password" id="examplePassword" placeholder="" value="0065 / Medical Reimbursement" />
      </FormGroup>
       <FormGroup>
       ...
       <FormGroup>
        <Label for="examplePassword">Receipt date</Label>
       ...
       <FormGroup>
        ...
        <Input type="text" name="text" id="examplePassword" placeholder="" value="Pengobatan Gigi" />
      </FormGroup>
       <FormGroup>
        <Label for="examplePassword">Reported Expense</Label>
        <Input type="text" name="text" id="examplePassword" placeholder="" value="Rp. 150.000,00" />
      </FormGroup>
       <FormGroup>
        <Label for="examplePassword">Approved Expense</Label>
        <Input type="text" name="password" id="examplePassword" placeholder="" value="Rp. 150.000,00" />
      </FormGroup>
       <FormGroup>
        <Label for="examplePassword">Ceiling Expense</Label>
        <Input type="text" name="password" id="examplePassword" placeholder="" value="Rp. 500.000,00" />
      </FormGroup>
      <FormGroup>
        <Label for="examplePassword">Receipt Attachment</Label>
        <Input type="text" name="password" id="examplePassword" placeholder="" value="kwitansi.pdf" />
      </FormGroup>
      <FormGroup>
