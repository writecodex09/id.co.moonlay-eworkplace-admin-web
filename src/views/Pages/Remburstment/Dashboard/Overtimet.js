...
class Overtimet extends Component {
  constructor(props) {
    super(props);
    this.state = {
      results: [],
...
<Table striped>
      ...
      <tbody>
          ...
          <td>Pending</td>
          <td>
            <Button outline color="secondary"><Link to="/remburstment/dashboard/overtime/dovertime">View Detail</Link></Button>{' '}
          </td>
