...
class Medicalt extends Component {
  constructor(props) {
    super(props);
    this.state = {
      results: [],
...
<Table striped>
      ...
      <tbody>
         <tr>
          ...
          <td>Pending</td>
          <td>
            <Button outline color="secondary"><Link to="/remburstment/dashboard/medical/dmedical">View Detail</Link></Button>{' '}
          </td>
