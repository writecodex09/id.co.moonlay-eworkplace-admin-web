...
class Ddtravel extends Component {
  constructor(props) {
    super(props);
    this.state = {
      results: [],
 ...
 // };
  ...
  <Form>
      ...
      <FormGroup>
        ...
        <Input type="text" name="password" id="examplePassword" placeholder="" value="0065 / Transport Reimbursement" />
      </FormGroup>
       <FormGroup>
       ...
       <FormGroup>
        ...
        <Input type="text" name="text" id="examplePassword" placeholder="" value="Bertemu User" />
      </FormGroup>
       <FormGroup>
        <Label for="examplePassword">Depature Location</Label>
        <Input type="text" name="text" id="examplePassword" placeholder="" value="Tanjung Barat" />
      </FormGroup>
       <FormGroup>
       ...
       <FormGroup>
        ...
        <Input type="text" name="password" id="examplePassword" placeholder="" value="Bukti.pdf" />
      </FormGroup>
      <FormGroup>
